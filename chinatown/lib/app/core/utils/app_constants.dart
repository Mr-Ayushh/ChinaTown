const String userListAPIBaseURL = 'https://reqres.in/api/users?page=';
const String userDetailsListAPIBaseURL = 'https://reqres.in/api/users/';
//https://reqres.in/api/users?page=2

const String newsAPIKey = ''; //'ff957763c54c44d8b00e5e082bc76cb0';
const String queryParam = 'page2';
