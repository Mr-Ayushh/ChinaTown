...
class FeaturedProductListPage extends StatefulWidget {
  const FeaturedProductListPage({super.key});

  @override
  State<FeaturedProductListPage> createState() =>
      _FeaturedProductListPageState();
}

class _FeaturedProductListPageState extends State<FeaturedProductListPage> {
